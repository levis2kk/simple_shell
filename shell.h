...
char *mbido(const char *, const char *);
...
int print_d(int, int);
char *tugharia(long int, int, int);
void wepu_okwu(char *);
...
int del_idx(list_t **, unsigned int);
...
list_t *npref_node(list_t *, char *, char);
